...
public class DefaultInterceptConfiguration implements InterceptConfiguration {
    ...
    public DefaultInterceptConfiguration(final ApplicationLog applicationLog, String... args) {
